            ...
            <div key={pizza.id} className='col-md-4 mb-3'>
              <div className='card'>
                ...
                <div className='card-body'>
                  ...
                  <button className='btn btn-danger me-1' onClick={()=> VerMas(pizza.id)}>Ver más</button>
                  <button className='btn btn-success ms-1' onClick={()=>anadirCarrito(pizza)}>Agregar 🛒</button>
                  </div>
                </div>
              </div>
            </div>
